...
/*
    ...
    "/static/SmartEditor/SmartEditor25kin.html"
    
    를 상황에 맞게 변경해서 써야한다
    
    예를 들어 Spring boot 서버의 context 경로가 /boot11이면
    
    "/boot11/static/SmartEditor/SmartEditor25kin.html" 가 된다.
    
    여기서 /static은 public 폴더 안에 있는 static 폴더를 가리킨다.
    
    폴더명을 gura라고 한다면 

    "/boot11/gura//SmartEditor/SmartEditor25kin.html"가 된다.
*/ 
